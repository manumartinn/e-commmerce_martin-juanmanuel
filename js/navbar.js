...
menu.push(`
        ...
        <div class="d-flex" style="margin-left: 2%">
          ...
          ${localStorage.getItem("email")
            ? `<p class="helloUser">Hola, ${localStorage.getItem('email')}</p><span style="color: white; margin-left: 10px; margin-right: 10px;">|</span>
            ...
            <b style="color: white" id="quantity">${localStorage.getItem('quantity')}</b><span style="color: white; margin-left: 10px; margin-right: 10px;">|</span><p onclick="closeSession()" class="closeSession">Cerrar sesion</p>`
            : `<button class="btn btn-outline-primary signin-btn" onclick="location.href='../pages/login.html'">Iniciar sesion</button>`
          }
          </div>
        </div>
      </div>
