...
menu.push(`
        ...
        <div class="d-flex" style="margin-left: 2%">
          ...
          ${localStorage.getItem("email")
            ...
            <b style="color: white; text-decoration: none;" id="quantity">${localStorage.getItem('quantity')}</b></a><span style="color: white; margin-left: 10px; margin-right: 10px;">|</span><p onclick="closeSession()" class="closeSession">Cerrar sesion</p>`
            : `<button class="btn btn-outline-primary signin-btn" onclick="location.href='../pages/login.html'"><span class="material-symbols-outlined">person</span>Iniciar sesion</button>`
          }
          </div>
        </div>
      </div>
